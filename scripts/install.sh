...
curl -fsSL -o /tmp/oh_my_zsh.sh https://raw.githubusercontent.com/hathaway/bootstrap/HEAD/scripts/oh_my_zsh.sh
...
curl -fsSL -o /tmp/homebrew.sh https://raw.githubusercontent.com/hathaway/bootstrap/HEAD/scripts/homebrew.sh
...
curl -fsSL -o /tmp/macos.sh https://raw.githubusercontent.com/hathaway/bootstrap/HEAD/scripts/macos.sh
